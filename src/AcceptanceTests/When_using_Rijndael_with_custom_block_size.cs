...
namespace NServiceBus.Encryption.MessageProperty.AcceptanceTests
{
    ...
    public class When_using_Rijndael_with_custom_block_size : NServiceBusAcceptanceTest
    {
        [Test]
        ...
        public class Endpoint : EndpointConfigurationBuilder
        {
            public Endpoint()
            {
                ...
                EndpointSetup<DefaultServer>(builder => builder.EnableMessagePropertyEncryption(
                    new MyRijndaelEncryptionService("1st", keys)));
            }
        ...
        public class MyRijndaelEncryptionService : RijndaelEncryptionService
        {
            public MyRijndaelEncryptionService(string encryptionKeyIdentifier, IDictionary<string, byte[]> keys) : base(encryptionKeyIdentifier, keys)
            {
            }
